...
/**
 * Validation rule for Javanese dates
 *
 * Usage: 'field' => ['required', new ValidJavaneseDate()]
 */
class ValidJavaneseDate implements ValidationRule
{
    /**
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        try {
            ...
            // Try to convert the date to Javanese
            Tanggalan::toJavanese($value);
